...
import com.devx.product.msproduct.MsProductApplication;
...
@Configuration
@ComponentScan("com.devx.product.msproduct.*")
@EnableSwagger2
...
public class SwaggerConfig {
    ...
    public Docket productApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apiInfo(metaData())
                .select()
                .apis(RequestHandlerSelectors.basePackage(MsProductApplication.class.getPackage().getName()))
